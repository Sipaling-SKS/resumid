...
const ExtractResumeMock = async (req) => {
  const cvContent = req.body.cvContent;
  console.log(cvContent);
  const response = {
    summary: {
      content:
        "Results-driven Informatics graduate with a strong interest in Business Improvement Analysis. Experienced in optimizing workflows, automating processes, and implementing innovative digital solutions across multiple industries. Skilled in data analysis, system integration, project management, and cross-functional collaboration to deliver sustainable business growth.",
    },
    workExperiences: [
      {
    ...
    educations: [
      {
        ...
        score: "3.75 / 4.00",
        description:
          "Specialized in Business Process Optimization, Software Development, and Data Analysis. Completed a final-year project on AI-powered workflow automation.",
      },
      {
