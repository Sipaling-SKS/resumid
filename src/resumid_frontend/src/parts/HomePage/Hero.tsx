...
function Hero() {
  return (
    <header className="relative responsive-container overflow-clip flex flex-col md:flex-row justify-center md:justify-between items-center md:py-16 border-b border-neutral-200 min-h-screen md:min-h-[70vh]">
      <div className="w-full md:w-3/5 pb-24 md:pb-0">
