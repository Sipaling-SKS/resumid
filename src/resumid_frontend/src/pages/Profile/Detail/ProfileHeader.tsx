...
export default function ProfileHeader({ queryKey, detail, isOwner = false, onSectionAdd }: ProfileHeaderProps) {
    ...
    <>
      <Card className="p-0 overflow-hidden space-y-0 rounded-none border-none">
        ...
        <div onClick={() => handleOpenDialog("banner")} className="relative w-full h-56 cursor-pointer">
          ...
          <img
            src="https://media.licdn.com/dms/image/v2/D5616AQHZsPp_t1dzlA/profile-displaybackgroundimage-shrink_350_1400/profile-displaybackgroundimage-shrink_350_1400/0/1737051648975?e=1757548800&v=beta&t=GORUaFPnLgrHBG38AYOqiaT7sYmLuocXEv52c89mdGs"
            alt="profile-banner"
        ...
        <div className="responsive-container">
          <CardContent className="relative pt-6 pb-8">
            <div className="flex flex-col sm:flex-row gap-8 items-start">
              {/* Avatar - left column */}
              <div className="flex-shrink-0 min-w-[180px] max-w-[280px] flex flex-col items-center">
                <Avatar onClick={() => handleOpenDialog("avatar")} className="cursor-pointer relative w-20 sm:w-full h-20 sm:h-full border-2 sm:border-4 border-white -mt-16 sm:-mt-32">
                  <div className="opacity-0 hover:opacity-100 transition-opacity absolute w-full h-full flex justify-center items-center bg-black/20">
                    <div className="flex justify-center items-center bg-black/50 text-white p-6 rounded-full backdrop-blur-[2px]">
                      <Eye />
                    </div>
      ...
      <BannerDialog queryKey={queryKey} url={"https://media.licdn.com/dms/image/v2/D5616AQHZsPp_t1dzlA/profile-displaybackgroundimage-shrink_350_1400/profile-displaybackgroundimage-shrink_350_1400/0/1737051648975?e=1757548800&v=beta&t=GORUaFPnLgrHBG38AYOqiaT7sYmLuocXEv52c89mdGs"} isOwner={isOwner} open={open.banner} setOpen={() => handleOpenDialog("banner")} />
      <AvatarDialog queryKey={queryKey} url={"https://github.com/shadcn.png"} isOwner={isOwner} open={open.avatar} setOpen={() => handleOpenDialog("avatar")} />
