      ...
      <CardContent className="text-center">
        {buttonText ? (
          <section className="flex justify-start w-full">
            <Button onClick={handlePress} variant="blue" className="w-fit text-sm font-inter " size="lg">
              {buttonText}
            </Button>
          </section>
        ) : (
...
function Features() {
  ...
  return (
    <section id="features" className="responsive-container py-28 border-b border-neutral-200 ">
